...
![image-20230218095507355](https://s2.loli.net/2023/02/18/l3hYMqmHFftI1xP.png)
...
- term查询：根据词条精确匹配，一般搜索**keyword**类型、数值类型、布尔类型、日期类型字段
...
![image-20220105114247614](assets/image-20220105114247614.png)
