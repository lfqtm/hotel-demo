...
![image-20211026220744895](img/image-20211026220744895.png)

![image-20211026220816423](img/image-20211026220816423.png)
...
#==============ES自动补全-类型
#=================================自动补全字段
# completion修饰的字段为自动补全字段,可以实现自动补全功能
# completion修饰的字段可以有多个值,以数组的形式存放数据
PUT /test
{
  "mappings": {
    "properties": {
